...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'date_facet_ssim', label: 'Year', range: true
    ...
    # config.add_facet_field solr_name("creator", :facetable), limit: 5, label: "Author", limit: 5
    ...
    #   Order here has no impact on display, as that is controlled by the view
    ...
    config.add_index_field solr_name('campus', :stored_searchable), itemprop: 'campus', link_to_search: solr_name('campus', :facetable)
    ...
    config.add_show_field solr_name('advisor', :stored_searchable)
    config.add_show_field solr_name('committee_member', :stored_searchable)
    ...
    config.add_search_field('campus') do |field|
      solr_name = solr_name('campus', :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
    ...
    config.add_search_field('rights_note') do |field|
      solr_name = solr_name('rights_note', :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
    ...
    config.add_search_field('rights_uri') do |field|
      solr_name = solr_name('rights_uri', :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
